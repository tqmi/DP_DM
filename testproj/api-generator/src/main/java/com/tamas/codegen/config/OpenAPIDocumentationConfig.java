package com.tamas.codegen.config;
...
public class OpenAPIDocumentationConfig {
    ...
    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.swaggerPetstore.base-path:/tqmi/petstoredemo/1.0.0}") String basePath) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.tamas.codegen.controllers"))
                    .build()
